...
SUPPORTED_ALGORITHMS = ["sha256", "sha3_224", "sha3_256", "sha3_384", "sha3_512", "blake2b", "blake2s"]
...
def hash(args):
    ...
    print(tabulate(hash_table, headers=["Algorithm", "Hash Value"], tablefmt="rounded_grid", stralign="left"))
